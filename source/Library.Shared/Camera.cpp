...
namespace Library
{
	...
	void Camera::Update(const pos3& lookfrom, const pos3& lookat, const precision& vertical_fov_degrees, const pos3& vertical_up, const precision& aperture, const precision& focus_dist)
	{
		_updated = true;
	...
	const pos3& Camera::GetPosition() const { return _origin; }
}